...
![观察者模式，图片来自 refactoringguru.cn](https://juzicoding.com/img/2025/01KDAEN3BHGEBMBWFGM9XGVVQB.webp)

简单来讲观察者🕵模式，就是当一个行为发生时传递信息给另外一个用户接收做出相应的处理，两者之间没有直接的耦合关联。例如；狙击手、李云龙。

![李云龙给你竖大拇指](https://juzicoding.com/img/2025/01KDAEN5JVKTQYGBRSFCD7Q63F.webp)
...
![场景模拟；小客车指标摇号通知场景](https://juzicoding.com/img/2025/01KDAEN84YARYMRH35SQ3NWSVR.webp)
...
![观察者模式模型结构](https://juzicoding.com/img/2025/01KDAENAT0D0CXRHD98RJN0142.webp)
