...
![状态模式，图片来自 refactoringguru.cn](https://juzicoding.com/img/2025/01KDAEND9JQNG6QWTHMP7C5N3Q.webp)

状态模式描述的是一个行为下的多种状态变更，比如我们最常见的一个网站的页面，在你登录与不登录下展示的内容是略有差异的(`不登录不能展示个人信息`)，而这种`登录`与`不登录`就是我们通过改变**状态**，而让整个行为发生了变化。

![收音机&放音机&磁带机](https://juzicoding.com/img/2025/01KDAENFJ20NDS4J9RE24MK8MT.webp)
...
![场景模拟；营销活动审核状态流转](https://juzicoding.com/img/2025/01KDAENJ04BYCFKE3PN13XNWY0.webp)
...
![状态模式模型结构](https://juzicoding.com/img/2025/01KDAENMGYHC10Z5FKBBVV6ZW5.webp)
