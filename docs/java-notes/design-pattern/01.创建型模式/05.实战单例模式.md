...
![单例模式，图片来自 refactoringguru.cn](https://juzicoding.com/img/2025/01KDAEHRRCK099M7AEKTQV6KZF.webp)
...
### 5.8 Effective  Java作者推荐的枚举单例(线程安全)
