...
![代理模式，图片来自 refactoringguru.cn](https://juzicoding.com/img/blog/166463933942487.png)
...
![场景模拟；实现mybatis-spring中代理类生成部分](https://juzicoding.com/img/blog/166463933947848.png)
...
![代理模式中间件模型结构](https://juzicoding.com/img/blog/166463933953308.png)
