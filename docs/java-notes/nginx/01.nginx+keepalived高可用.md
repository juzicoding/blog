...
![keepalived + nginx高可用-传统高可用](https://juzicoding.com/img/2025/01KDAEWFQS688BH5C5782S4JSX.webp)
...
![keepalived + nginx高可用-LVS示意图](https://juzicoding.com/img/2025/01KDAEWHZKDXF3HQPD07W1WK07.webp)

### 2.2 nginx+keepalived

在传统高可用的基础上，利用多台服务器集群借助 keepavlied 管理 LVS 虚拟出一个虚拟ip，只要两台 nginx 服务器不宕机那么服务就不会瘫痪，如下图：

![keepalived + nginx高可用-nginx_keepalived](https://juzicoding.com/img/2025/01KDAEWMA420X1RKCJZYW58WHC.webp)
...
![关闭selinux](https://juzicoding.com/img/2025/01KDAEWPZVM23VNTW3MTH1BDNX.webp)
...
![VM11ipaddr](https://juzicoding.com/img/2025/01KDAEWS37RFH9VE84ZSX2DYV9.webp)

![VM12ipaddr](https://juzicoding.com/img/2025/01KDAEWV85HS9DPPEASCKJV146.webp)
...
![抓包异常情况](https://juzicoding.com/img/2025/01KDAEWXENM80ZVX2B13FRPNNK.webp)

为了验证一下，把两台机器的防火墙全部关闭，命令：`systemctl stop firewalld.service`，发现情况正常了。

![抓包正常情况](https://juzicoding.com/img/2025/01KDAEWZCK8FWRZXKX0F3BEEAE.webp)

`ip addr` 查看，发现配置成功了。

![master_success](https://juzicoding.com/img/2025/01KDAEX1FQQPQ7MQ50NQP4KSVF.webp)

![backup_success](https://juzicoding.com/img/2025/01KDAEX3K6H2DH52Q9QH40FA76.webp)
...
![kill_master](https://juzicoding.com/img/2025/01KDAEX5NXVY0JMZSSV2WYBMSJ.webp)

可以看到 BACKUP 备份机已经接管了。

![BACKUP_MASTER](https://juzicoding.com/img/2025/01KDAEX7TMCAYFFK0MWN0VQ2MX.webp)

而当 MASTER 主机重启之后，MASTER 主机又会抢回虚拟ip的控制权。

## 5. nginx+keepalived配合使用
...
### 5.2 配置keepalived配置文件

增加的配置如图：

![keepalived心跳检测nginx](https://juzicoding.com/img/2025/01KDAEXA5JR4ESXQANCK4BXKX6.webp)
...
![打不死的nginx](https://juzicoding.com/img/2025/01KDAEXCA563350MKGBGR3755J.webp)
