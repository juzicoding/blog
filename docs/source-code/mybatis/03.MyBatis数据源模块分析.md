...
![工厂方法模式](https://juzicoding.com/img/2025/01KDAF0PG2HN5SVMPESZ775HX3.webp)
...
### 2.2 总结一下连接池获取回收连接的过程

#### getConnection() 

![getConn](https://juzicoding.com/img/2025/01KDAF0RS36V6Z5PXXAMMT17JF.webp)

#### pushConnection()

![pushConn](https://juzicoding.com/img/2025/01KDAF0V0R0WR5CPJP91HMF3PS.webp)