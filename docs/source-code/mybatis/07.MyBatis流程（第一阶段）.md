...
![MyBatis流程（第一阶段）配置加载的几个重要的类](https://juzicoding.com/img/2025/01KDAF10VR2DYY50JP7A6YB2X4.webp)
...
![MyBatis流程（第一阶段）类作用图示](https://juzicoding.com/img/2025/01KDAF132CK5XY75DFDTWNXS79.webp)
...
![MyBatis流程（第一阶段）配置加载的四个步骤](https://juzicoding.com/img/2025/01KDAF14YC9ASSVQB08NY45AHA.webp)
...
![mappedStatement](https://juzicoding.com/img/2025/01KDAF172NYMPKX050PFGFZ50S.webp)
