...
# 过滤出长度大于 3 的字符串
name_list = ['juzicoding', 'tom', 'jerry', 'wxe']
...
# Counter({'j': 1, 'u': 1, 'z': 1, 'i': 2, 'c': 1, 'o': 1, 'd': 1, 'n': 1, 'g': 1})
print(char_count)
```
