...
![docker使用自定义配置那件构建redis镜像](https://juzicoding.com/img/2025/01KDAEAS5HNK9DCJEMQ6TDD264.webp)

## 2. 通过DockerFile构建镜像，指定配置文件启动
...
![构建自定义配置redis镜像](https://juzicoding.com/img/2025/01KDAEAV3KMW2K25SY40HS2PW0.webp)
...
![自定义redis镜像自动](https://juzicoding.com/img/2025/01KDAEAX0NMKYJNF3TW43SP8YD.webp)

同时可以测试下密码也可以正常连接。

![自定义redis容器连接](https://juzicoding.com/img/2025/01KDAEAZBEE63VQQSJG7VQPSXE.webp)