...
![docker使用自定义配置那件构建redis镜像](https://juzicoding.com/img/blog/166463756863926.png)
...
![构建自定义配置redis镜像](https://juzicoding.com/img/blog/166463756869305.png)
...
![自定义redis镜像自动](https://juzicoding.com/img/blog/166463756874124.png)

同时可以测试下密码也可以正常连接。

![自定义redis容器连接](https://juzicoding.com/img/blog/166463756879581.png)