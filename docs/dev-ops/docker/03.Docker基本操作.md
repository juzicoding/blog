...
![列出本地镜像列表](https://juzicoding.com/img/blog/166463730587286.png)
...
![获取mysql5.7镜像](https://juzicoding.com/img/blog/166463730602293.png)
...
![删除hellor-world镜像](https://juzicoding.com/img/blog/166463730617201.png)
...
![查看容器列表](https://juzicoding.com/img/blog/166463730640241.png)
...
![后台启动tomcat8090](https://juzicoding.com/img/blog/166463730657615.png)
...
![交互式创建容器并进入容器](https://juzicoding.com/img/blog/166463730692873.png)

可以看到两者的不同，但是需要注意，交互式启动容器，一旦执行 exit 命令那么容器也会 stop，查看结果如下图，tomcat8091 已经处于停止状态。

![image-20210627203710815](https://juzicoding.com/img/blog/166463730695832.png)
...
![draw挂载目录运行效果](https://juzicoding.com/img/blog/166463730729617.png)
...
![docker容器默认网段ip](https://juzicoding.com/img/blog/166463730753223.png)
...
![docker更改网段ip](https://juzicoding.com/img/blog/166463730750939.png)

同样宿主机和docker相互访问也是通过网卡来访问的，docker安装后会新增一个网卡，使用 `ip addr` 命令查看。

![docker网卡](https://juzicoding.com/img/blog/166463730762209.png)
...
![进入容器进行交互操作](https://juzicoding.com/img/blog/166463730763904.png)
...
![容器和主机间的数据拷贝](https://juzicoding.com/img/blog/166463730767047.png)
...
![通过容器生成镜像](https://juzicoding.com/img/blog/166463730783179.png)
...
![创建docker仓库](https://juzicoding.com/img/blog/166463730777311.png)

#### 上传示例

1、登录 docker，输入注册的用户名密码登录即可，警告可参考提示文档解决。

![docker登录](https://juzicoding.com/img/blog/166463730783361.png)

2、再使用 tag 命令标记一个镜像，指定自己创建的仓库。

![docker指定自己的仓库](https://juzicoding.com/img/blog/166463730802916.png)

3、使用 push 命令推送此镜像到 docker 官方仓库里。

![docker推送镜像到官方仓库](https://juzicoding.com/img/blog/166463730804032.png)

4、查询自己的仓库，可以看到刚才设置的 v1 版本已经提交了，如果是公共仓库，那么别人也可以从你这里获取镜像，命令：`docker pull itwxe/tomcat_drawio:v1` 。

![docker查看提交的镜像](https://juzicoding.com/img/blog/166463730795143.png)
...
![启动私服仓库容器](https://juzicoding.com/img/blog/166463730795394.png)
...
![提交镜像到私服仓库](https://juzicoding.com/img/blog/166463730811802.png)
