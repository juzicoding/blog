...
![列出本地镜像列表](https://juzicoding.com/img/2025/01KDAE91DWN565P9G406PB8ENH.webp)
...
![获取mysql5.7镜像](https://juzicoding.com/img/2025/01KDAE939QSCZ3N6FSBN2CG724.webp)
...
![删除hellor-world镜像](https://juzicoding.com/img/2025/01KDAE953V0PYASASBFHECHVE1.webp)
...
![查看容器列表](https://juzicoding.com/img/2025/01KDAE96XTTVBZM6290B14E45N.webp)
...
![后台启动tomcat8090](https://juzicoding.com/img/2025/01KDAE98S0XXDHRHYH6CMAHDVB.webp)
...
![交互式创建容器并进入容器](https://juzicoding.com/img/2025/01KDAE9AQ7HTYM53ZJHNP5VKQM.webp)

可以看到两者的不同，但是需要注意，交互式启动容器，一旦执行 exit 命令那么容器也会 stop，查看结果如下图，tomcat8091 已经处于停止状态。

![image-20210627203710815](https://juzicoding.com/img/2025/01KDAE9CJ0NY1KFKXM1499PEZC.webp)
...
![draw挂载目录运行效果](https://juzicoding.com/img/2025/01KDAE9ET2EASXBSNDE28NFECK.webp)
...
![docker容器默认网段ip](https://juzicoding.com/img/2025/01KDAE9GNJXBSZDQSN95JDD05Z.webp)
...
![docker更改网段ip](https://juzicoding.com/img/2025/01KDAE9JGZB6HY9BEK5JEX0EVF.webp)

同样宿主机和docker相互访问也是通过网卡来访问的，docker安装后会新增一个网卡，使用 `ip addr` 命令查看。

![docker网卡](https://juzicoding.com/img/2025/01KDAE9MMYG9MTP2E0X5B9A23C.webp)
...
![进入容器进行交互操作](https://juzicoding.com/img/2025/01KDAE9PG7BN5MV59F1C60YS0X.webp)
...
![容器和主机间的数据拷贝](https://juzicoding.com/img/2025/01KDAE9RBB7G8EQ8NQZVYBM9SY.webp)
...
![通过容器生成镜像](https://juzicoding.com/img/2025/01KDAE9T6E7H9RE0TXYQ4WJYPF.webp)
...
![创建docker仓库](https://juzicoding.com/img/2025/01KDAE9WGQPKP2TSRPNSJK5E3A.webp)

#### 上传示例

1、登录 docker，输入注册的用户名密码登录即可，警告可参考提示文档解决。

![docker登录](https://juzicoding.com/img/2025/01KDAE9YC15FW45M0XMW1K89QB.webp)

2、再使用 tag 命令标记一个镜像，指定自己创建的仓库。

![docker指定自己的仓库](https://juzicoding.com/img/2025/01KDAEA07J3C3GHWEDGZXA7FVC.webp)

3、使用 push 命令推送此镜像到 docker 官方仓库里。

![docker推送镜像到官方仓库](https://juzicoding.com/img/2025/01KDAEA226353WYTYH11YBVNQ0.webp)

4、查询自己的仓库，可以看到刚才设置的 v1 版本已经提交了，如果是公共仓库，那么别人也可以从你这里获取镜像，命令：`docker pull itwxe/tomcat_drawio:v1` 。

![docker查看提交的镜像](https://juzicoding.com/img/2025/01KDAEA4DQ5VGKMBKKG6QW4HQJ.webp)
...
![启动私服仓库容器](https://juzicoding.com/img/2025/01KDAEA68THGENGXYR635ADWTT.webp)
...
![提交镜像到私服仓库](https://juzicoding.com/img/2025/01KDAEA8FX066FV8GQZWPCH025.webp)
