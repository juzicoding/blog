...
![配置基础](https://juzicoding.com/img/2025/01KDAECQE6WH8Q2CZE2Z64A34S.webp)
...
![窗口设置](https://juzicoding.com/img/2025/01KDAECSQH707BMFQ9KXX5NVR7.webp)

2、Window -> Appearance

Font setting -> Change 调整字体。

![字体设置](https://juzicoding.com/img/2025/01KDAECVWY0Q8C8PJ6YTDQ2S3D.webp)

3、Connection -> keepalives: 60

长时间不操作断开连接，设置 keepalive 保持连接，比如设置为60秒发送一个空数据包保持连接。

![keepalive](https://juzicoding.com/img/2025/01KDAECY0RX97H7H9XFZ7DECP2.webp)

4、Connection -> Data

Auto-login username 可填写登录用户名。省去每次需要填写Username的麻烦。

![默认用户名](https://juzicoding.com/img/2025/01KDAED065J65TFHAPNVAP7PS3.webp)
...
![配色效果图](https://juzicoding.com/img/2025/01KDAED2B97NJA4656RXAG3XE9.webp)
...
![密钥开始生成](https://juzicoding.com/img/2025/01KDAED4HD0Z6R06NS5NJ1Q25V.webp)

![密钥生成中](https://juzicoding.com/img/2025/01KDAED6RCJHYZEF0AKTQ8GV5K.webp)

2、密钥生成后保存复制公钥及保存私钥。

![密钥生成完成](https://juzicoding.com/img/2025/01KDAED8XDNZ3T884HNKZ92WH4.webp)
...
![默认用户名](https://juzicoding.com/img/2025/01KDAEDB16FB5HX8HHS3G326QY.webp)

然后点击 SSH -> Auth -> Browse，选择保存的私钥位置。

![选择私钥](https://juzicoding.com/img/2025/01KDAEDD42263HJ0DBHSY6493Q.webp)

**最关键的一步**，一定不要忘了保存，特别是如果没有显示 HostName 和 Saved Sessions 一定要点击 load，再点击保存，不然设置不生效。

![保存设置](https://juzicoding.com/img/2025/01KDAEDF8RSCNKQXQK9616MXDF.webp)
...
![WinSCP](https://juzicoding.com/img/2025/01KDAEDHKVYZ16QPB6AXX9HX37.webp)

拖拽即可上传，这是单栏模式，也可以设置成类似 xftp 的双栏模式。

![单栏WinSCP](https://juzicoding.com/img/2025/01KDAEDM1TF7T026E1YJ6M9Y3G.webp)