...
![Docker化文件](https://juzicoding.com/img/blog/166463839065256.png)
...
![创建lsky数据库](https://juzicoding.com/img/blog/166463839073505.png)
...
![LskyPro安装1](https://juzicoding.com/img/blog/166463839095625.png)
...
![LskyPro安装2](https://juzicoding.com/img/blog/166463839104144.png)

看到这个界面之后点击下一步，输入你的 MySQL 地址，用户名密码等信息，点击配置数据库。

![LskyPro安装3](https://juzicoding.com/img/blog/166463839119653.png)

配置之后输入你的管理员信息。

![LskyPro安装4](https://juzicoding.com/img/blog/166463839142771.png)

安装成功后的截图。

![LskyPro安装5](https://juzicoding.com/img/blog/166463839157397.png)



![LskyPro安装6](https://juzicoding.com/img/blog/166463839175347.png)
...
![LskyPro配置接口](https://juzicoding.com/img/blog/166463839195252.png)

设置之后刷新界面界面就会出现接口菜单了，如图：

![image-20210812074329584](https://juzicoding.com/img/blog/166463839199630.png)
...
![生成LskyProToken](https://juzicoding.com/img/blog/166463839212378.png)
...
![安装lskypro插件](https://juzicoding.com/img/blog/166463839221784.png)

安装成功之后点击图床设置，设置为 Lsky Pro 为默认图床，输入 Url 和 Token 后确定即可。

![配置PicGo](https://juzicoding.com/img/blog/166463839210241.png)
...
![Typora上传图片设置](https://juzicoding.com/img/blog/166463839231347.png)

点击验证图片上传选项，验证是否可以正常上传。

![验证图片上传](https://juzicoding.com/img/blog/166463839226202.png)

验证成功后只要截图后，直接 ctrl + v 粘贴到Typora里面就可以自动上传到自建的图床并且返回图片链接了，如我正在写文章的示例结果图：

![效果图](https://juzicoding.com/img/blog/166463839237483.png)

最后查看一下我们的图床，图片是否上传。

![图片上传结果](https://juzicoding.com/img/blog/166463839229069.png)
