...
![Docker化文件](https://juzicoding.com/img/2025/01KDAE6EYPEYX8M5JCNZB7KCCY.webp)
...
![创建lsky数据库](https://juzicoding.com/img/2025/01KDAE6HD4PFGEV0W5RFGDH4GV.webp)
...
![LskyPro安装1](https://juzicoding.com/img/2025/01KDAE6KWKWZXHD5VGC3V80TRE.webp)
...
![LskyPro安装2](https://juzicoding.com/img/2025/01KDAE6P7Q1Z63B8Z5E4XSXB7C.webp)

看到这个界面之后点击下一步，输入你的 MySQL 地址，用户名密码等信息，点击配置数据库。

![LskyPro安装3](https://juzicoding.com/img/2025/01KDAE6RS3B554KAANERJN72WQ.webp)

配置之后输入你的管理员信息。

![LskyPro安装4](https://juzicoding.com/img/2025/01KDAE6V5XYEPB1GP3RK06VHSM.webp)

安装成功后的截图。

![LskyPro安装5](https://juzicoding.com/img/2025/01KDAE6XDMQNB5DV2V4BN4H1A4.webp)



![LskyPro安装6](https://juzicoding.com/img/2025/01KDAE6ZQYSW7B8EESFGQ6HHMG.webp)
...
![LskyPro配置接口](https://juzicoding.com/img/2025/01KDAE72BDT5XSH7EJZXY2D8JX.webp)

设置之后刷新界面界面就会出现接口菜单了，如图：

![image-20210812074329584](https://juzicoding.com/img/2025/01KDAE74BTJ1328M647KZHJ3AX.webp)
...
![生成LskyProToken](https://juzicoding.com/img/2025/01KDAE76F6TAJ5GKJNTHXV3GN1.webp)
...
![安装lskypro插件](https://juzicoding.com/img/2025/01KDAE78HAXBDC1TSNHBWT9RE3.webp)

安装成功之后点击图床设置，设置为 Lsky Pro 为默认图床，输入 Url 和 Token 后确定即可。

![配置PicGo](https://juzicoding.com/img/2025/01KDAE7AME7A2735Q9WQ98V4RZ.webp)
...
![Typora上传图片设置](https://juzicoding.com/img/2025/01KDAE7CR11RDFWT16FN1K42H0.webp)

点击验证图片上传选项，验证是否可以正常上传。

![验证图片上传](https://juzicoding.com/img/2025/01KDAE7EV689G0QN035GZ4EA5F.webp)

验证成功后只要截图后，直接 ctrl + v 粘贴到Typora里面就可以自动上传到自建的图床并且返回图片链接了，如我正在写文章的示例结果图：

![效果图](https://juzicoding.com/img/2025/01KDAE7H21HA89FWQTVJ52VP06.webp)

最后查看一下我们的图床，图片是否上传。

![图片上传结果](https://juzicoding.com/img/2025/01KDAE7KK8TG5RZC4FBSQM2TQV.webp)
